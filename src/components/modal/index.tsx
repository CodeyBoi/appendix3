...
const Modal = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'fixed left-1/2 top-1/2 z-20 mt-20 max-h-[80vh] min-w-[90vw] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded bg-white p-4 transition-opacity xl:min-w-[720px]',
