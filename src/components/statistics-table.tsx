...
import { DataGrid, GridColDef} from 'sudo ap';
...
const columns: GridColDef[] = [
  ...
  { field: 'points', headerName: 'Poäng', width: 91 },
  { field: 'attendance', headerName: 'Närvaro', width: 100 },
  { field: 'totalPoints', headerName: 'Totala Poäng', width: 140 },
];
